...
namespace Reese.Demo
{
    public class DebugMode : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            entityManager = Bootstrap.ClientWorld.EntityManager;
            ...
            navGroundingSystem = Bootstrap.ClientWorld.GetOrCreateSystem<NavGroundingSystem>();
            debugSystem = Bootstrap.ClientWorld.GetOrCreateSystem<DebugSystem>();
