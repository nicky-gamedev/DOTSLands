...
namespace Unity.Physics.Stateful
{
    ...
    public class TriggerEventConversionSystem : SystemBase
    {
        ...
        [AutoAssign] private StepPhysicsWorld m_StepPhysicsWorld = default;
        [AutoAssign] private BuildPhysicsWorld m_BuildPhysicsWorld = default;
        [AutoAssign] private EndFramePhysicsSystem m_EndFramePhysicsSystem = default;
        ...
        {
            base.OnStartRunning();
            bool isConnected = Bootstrap.ClientWorld.GetExistingSystem<NetworkClientSystem>().state == ClientState.CONNECTED;
            if (isConnected)
            {
